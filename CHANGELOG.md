...
- Updated `uhf-server` to version `1.6.0` ([Changelog](https://github.com/swapplications/uhf-server-dist/blob/main/CHANGELOG.md))

#### Docker Compose Changes
- Update `image` tag to `solidpixel/uhf-server:uhf-1.6.0-ffmpeg7.1.1-d1`
